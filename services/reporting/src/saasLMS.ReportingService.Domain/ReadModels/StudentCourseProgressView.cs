...
public class StudentCourseProgressView : Entity<Guid>
{
    ...
    protected StudentCourseProgressView()
    {
    }

    public StudentCourseProgressView(Guid id, Guid tenantId, Guid courseId, Guid studentId)
        : base(id)
    {
        TenantId = tenantId;
        CourseId = courseId;
