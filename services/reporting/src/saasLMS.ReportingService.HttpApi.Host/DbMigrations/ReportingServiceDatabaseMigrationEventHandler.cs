...
public class ReportingServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<ReportingServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public ReportingServiceDatabaseMigrationEventHandler(
