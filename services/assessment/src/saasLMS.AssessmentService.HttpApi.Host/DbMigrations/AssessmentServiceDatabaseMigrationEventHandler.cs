...
public class AssessmentServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<AssessmentServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public AssessmentServiceDatabaseMigrationEventHandler(
