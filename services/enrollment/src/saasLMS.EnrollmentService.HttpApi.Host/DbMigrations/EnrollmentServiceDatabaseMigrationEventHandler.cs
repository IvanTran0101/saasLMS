...
public class EnrollmentServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<EnrollmentServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public EnrollmentServiceDatabaseMigrationEventHandler(
