...
public class NotificationServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<NotificationServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public NotificationServiceDatabaseMigrationEventHandler(
