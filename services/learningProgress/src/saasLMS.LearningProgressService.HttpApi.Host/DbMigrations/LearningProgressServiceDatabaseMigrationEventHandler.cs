...
using saasLMS.Shared.Hosting.Microservices.DbMigrations;
using Volo.Abp.Data;
...
namespace saasLMS.LearningProgressService.DbMigrations;

public class LearningProgressServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<LearningProgressServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public LearningProgressServiceDatabaseMigrationEventHandler(
        ...
        tenantRepository,
        distributedEventBus,
        LearningProgressServiceDbProperties.ConnectionStringName)
    {
