...
using saasLMS.LearningProgressService.DbMigrations;
...
[DependsOn(
    ...
    typeof(LearningProgressServiceHttpApiModule),
    typeof(LearningProgressServiceEntityFrameworkCoreModule)
    )]
public class LearningProgressServiceHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        JwtBearerConfigurationHelper.Configure(context, "LearningProgressService");
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "LearningProgressService API");
    ...
    public async override Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        using (var scope = context.ServiceProvider.CreateScope())
        {
            await scope.ServiceProvider
                .GetRequiredService<LearningProgressServiceDatabaseMigrationChecker>()
