...
public class CourseCatalogServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<CourseCatalogServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public CourseCatalogServiceDatabaseMigrationEventHandler(
