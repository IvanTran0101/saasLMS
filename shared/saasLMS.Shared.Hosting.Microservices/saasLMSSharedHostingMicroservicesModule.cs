...
namespace saasLMS.Shared.Hosting.Microservices;
...
public class saasLMSSharedHostingMicroservicesModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            .AddDataProtection()
            .SetApplicationName("saasLMS")
            .PersistKeysToStackExchangeRedis(redis, "saasLMS-Protection-Keys");
