...
Necessary helm charts are created under `etc/k8s/saaslms` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
````powershell
127.0.0.1 blazor.saaslms.dev
127.0.0.1 saaslms.dev
127.0.0.1 authserver.saaslms.dev
127.0.0.1 identity.saaslms.dev
127.0.0.1 administration.saaslms.dev
127.0.0.1 product.saaslms.dev
127.0.0.1 saas.saaslms.dev
127.0.0.1 gateway-web.saaslms.dev
127.0.0.1 gateway-public.saaslms.dev
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `saaslms` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://saaslms-st-public-web for public and
   https://saaslms-st-blazor for the back-office application
